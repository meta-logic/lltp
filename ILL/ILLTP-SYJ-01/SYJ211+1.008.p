...
fof(ax10, axiom, !((!(a0) -o !(f)))). 

fof(ax9, axiom, !((!(!((!((!(!((!(b8) -o 0))) -o !(b0))) -o 0))) -o !(a8)))). 

fof(ax8, axiom, !((!(!((!((!(!((!(b0) -o 0))) -o !(a1))) -o 0))) -o !(a0)))). 

fof(ax7, axiom, !((!(!((!((!(!((!(b1) -o 0))) -o !(a2))) -o 0))) -o !(a1)))). 

fof(ax6, axiom, !((!(!((!((!(!((!(b2) -o 0))) -o !(a3))) -o 0))) -o !(a2)))). 

fof(ax5, axiom, !((!(!((!((!(!((!(b3) -o 0))) -o !(a4))) -o 0))) -o !(a3)))). 

fof(ax4, axiom, !((!(!((!((!(!((!(b4) -o 0))) -o !(a5))) -o 0))) -o !(a4)))). 

fof(ax3, axiom, !((!(!((!((!(!((!(b5) -o 0))) -o !(a6))) -o 0))) -o !(a5)))). 

fof(ax2, axiom, !((!(!((!((!(!((!(b6) -o 0))) -o !(a7))) -o 0))) -o !(a6)))). 

fof(ax1, axiom, !((!(!((!((!(!((!(b7) -o 0))) -o !(a8))) -o 0))) -o !(a7)))). 

fof(con11, conjecture, f). 
