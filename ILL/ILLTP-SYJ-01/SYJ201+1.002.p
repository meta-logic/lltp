...
fof(ax5, axiom, !((!(!((!((!(p1) -o p2)) & !((!(p2) -o p1))))) -o !((!(p1) & !((!(p2) & !((!(p3) & !((!(p4) & !(p5)))))))))))). 

fof(ax4, axiom, !((!(!((!((!(p2) -o p3)) & !((!(p3) -o p2))))) -o !((!(p1) & !((!(p2) & !((!(p3) & !((!(p4) & !(p5)))))))))))). 

fof(ax3, axiom, !((!(!((!((!(p3) -o p4)) & !((!(p4) -o p3))))) -o !((!(p1) & !((!(p2) & !((!(p3) & !((!(p4) & !(p5)))))))))))). 

fof(ax2, axiom, !((!(!((!((!(p4) -o p5)) & !((!(p5) -o p4))))) -o !((!(p1) & !((!(p2) & !((!(p3) & !((!(p4) & !(p5)))))))))))). 

fof(ax1, axiom, !((!(!((!((!(p5) -o p1)) & !((!(p1) -o p5))))) -o !((!(p1) & !((!(p2) & !((!(p3) & !((!(p4) & !(p5)))))))))))). 

fof(con6, conjecture, !((p1 & !((p2 & !((p3 & !((p4 & p5))))))))). 
