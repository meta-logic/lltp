...
fof(con1, conjecture, !((!((!((!((!(a0) -o !(f))) & !((!((!(!((!(b4) -o b0))) -o !(a4))) & !((!((!(!((!(b0) -o a1))) -o !(a0))) & !((!((!(!((!(b1) -o a2))) -o !(a1))) & !((!((!(!((!(b2) -o a3))) -o !(a2))) & !((!(!((!(b3) -o a4))) -o !(a3))))))))))))) -o f)) & !((!((!((!(!((!(b3) -o a4))) -o !(a3))) & !((!((!(!((!(b2) -o a3))) -o !(a2))) & !((!((!(!((!(b1) -o a2))) -o !(a1))) & !((!((!(!((!(b0) -o a1))) -o !(a0))) & !((!((!(!((!(b4) -o b0))) -o !(a4))) & !((!(a0) -o !(f))))))))))))) -o f))))). 
