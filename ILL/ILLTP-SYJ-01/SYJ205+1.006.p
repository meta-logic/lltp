...
fof(con1, conjecture, !((!((!((!((!(a0) -o !(f))) & !((!((!(!((!(b6) -o b0))) -o !(a6))) & !((!((!(!((!(b0) -o a1))) -o !(a0))) & !((!((!(!((!(b1) -o a2))) -o !(a1))) & !((!((!(!((!(b2) -o a3))) -o !(a2))) & !((!((!(!((!(b3) -o a4))) -o !(a3))) & !((!((!(!((!(b4) -o a5))) -o !(a4))) & !((!(!((!(b5) -o a6))) -o !(a5))))))))))))))))) -o f)) & !((!((!((!(!((!(b5) -o a6))) -o !(a5))) & !((!((!(!((!(b4) -o a5))) -o !(a4))) & !((!((!(!((!(b3) -o a4))) -o !(a3))) & !((!((!(!((!(b2) -o a3))) -o !(a2))) & !((!((!(!((!(b1) -o a2))) -o !(a1))) & !((!((!(!((!(b0) -o a1))) -o !(a0))) & !((!((!(!((!(b6) -o b0))) -o !(a6))) & !((!(a0) -o !(f))))))))))))))))) -o f))))). 
