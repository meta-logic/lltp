...
fof(ax8, axiom, !((!((!(p7) -o 0)) -o 0))). 

fof(ax7, axiom, !((!(p1) -o !((!(p1) -o !(p0)))))). 

fof(ax6, axiom, !((!(p2) -o !((!(p2) -o !(p1)))))). 

fof(ax5, axiom, !((!(p3) -o !((!(p3) -o !(p2)))))). 

fof(ax4, axiom, !((!(p4) -o !((!(p4) -o !(p3)))))). 

fof(ax3, axiom, !((!(p5) -o !((!(p5) -o !(p4)))))). 

fof(ax2, axiom, !((!(p6) -o !((!(p6) -o !(p5)))))). 

fof(ax1, axiom, !((!(p7) -o !((!(p7) -o !(p6)))))). 

fof(con9, conjecture, !(p0)). 
