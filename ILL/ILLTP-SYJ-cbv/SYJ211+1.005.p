...
fof(ax7, axiom, !((!(a0) -o !(f)))). 

fof(ax6, axiom, !((!((!((!((!(b5) -o 0)) -o !(b0))) -o 0)) -o !(a5)))). 

fof(ax5, axiom, !((!((!((!((!(b0) -o 0)) -o !(a1))) -o 0)) -o !(a0)))). 

fof(ax4, axiom, !((!((!((!((!(b1) -o 0)) -o !(a2))) -o 0)) -o !(a1)))). 

fof(ax3, axiom, !((!((!((!((!(b2) -o 0)) -o !(a3))) -o 0)) -o !(a2)))). 

fof(ax2, axiom, !((!((!((!((!(b3) -o 0)) -o !(a4))) -o 0)) -o !(a3)))). 

fof(ax1, axiom, !((!((!((!((!(b4) -o 0)) -o !(a5))) -o 0)) -o !(a4)))). 

fof(con8, conjecture, !(f)). 
