...
fof(con1, conjecture, (!(((!((!(a0) -o !(f))) * (!((!((!(b12) -o !(b0))) -o !(a12))) * (!((!((!(b0) -o !(a1))) -o !(a0))) * (!((!((!(b1) -o !(a2))) -o !(a1))) * (!((!((!(b2) -o !(a3))) -o !(a2))) * (!((!((!(b3) -o !(a4))) -o !(a3))) * (!((!((!(b4) -o !(a5))) -o !(a4))) * (!((!((!(b5) -o !(a6))) -o !(a5))) * (!((!((!(b6) -o !(a7))) -o !(a6))) * (!((!((!(b7) -o !(a8))) -o !(a7))) * (!((!((!(b8) -o !(a9))) -o !(a8))) * (!((!((!(b9) -o !(a10))) -o !(a9))) * (!((!((!(b10) -o !(a11))) -o !(a10))) * !((!((!(b11) -o !(a12))) -o !(a11)))))))))))))))) -o !(f))) * !(((!((!((!(b11) -o !(a12))) -o !(a11))) * (!((!((!(b10) -o !(a11))) -o !(a10))) * (!((!((!(b9) -o !(a10))) -o !(a9))) * (!((!((!(b8) -o !(a9))) -o !(a8))) * (!((!((!(b7) -o !(a8))) -o !(a7))) * (!((!((!(b6) -o !(a7))) -o !(a6))) * (!((!((!(b5) -o !(a6))) -o !(a5))) * (!((!((!(b4) -o !(a5))) -o !(a4))) * (!((!((!(b3) -o !(a4))) -o !(a3))) * (!((!((!(b2) -o !(a3))) -o !(a2))) * (!((!((!(b1) -o !(a2))) -o !(a1))) * (!((!((!(b0) -o !(a1))) -o !(a0))) * (!((!((!(b12) -o !(b0))) -o !(a12))) * !((!(a0) -o !(f)))))))))))))))) -o !(f))))). 
