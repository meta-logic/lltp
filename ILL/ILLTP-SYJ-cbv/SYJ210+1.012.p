...
fof(ax13, axiom, !((!((!(p12) -o 0)) -o 0))). 

fof(ax12, axiom, !((!(p1) -o !((!(p1) -o !(p0)))))). 

fof(ax11, axiom, !((!(p2) -o !((!(p2) -o !(p1)))))). 

fof(ax10, axiom, !((!(p3) -o !((!(p3) -o !(p2)))))). 

fof(ax9, axiom, !((!(p4) -o !((!(p4) -o !(p3)))))). 

fof(ax8, axiom, !((!(p5) -o !((!(p5) -o !(p4)))))). 

fof(ax7, axiom, !((!(p6) -o !((!(p6) -o !(p5)))))). 

fof(ax6, axiom, !((!(p7) -o !((!(p7) -o !(p6)))))). 

fof(ax5, axiom, !((!(p8) -o !((!(p8) -o !(p7)))))). 

fof(ax4, axiom, !((!(p9) -o !((!(p9) -o !(p8)))))). 

fof(ax3, axiom, !((!(p10) -o !((!(p10) -o !(p9)))))). 

fof(ax2, axiom, !((!(p11) -o !((!(p11) -o !(p10)))))). 

fof(ax1, axiom, !((!(p12) -o !((!(p12) -o !(p11)))))). 

fof(con14, conjecture, !(p0)). 
