...
fof(ax7, axiom, !((!((!(p6) -o 0)) -o 0))). 

fof(ax6, axiom, !((!(p1) -o !((!(p1) -o !(p0)))))). 

fof(ax5, axiom, !((!(p2) -o !((!(p2) -o !(p1)))))). 

fof(ax4, axiom, !((!(p3) -o !((!(p3) -o !(p2)))))). 

fof(ax3, axiom, !((!(p4) -o !((!(p4) -o !(p3)))))). 

fof(ax2, axiom, !((!(p5) -o !((!(p5) -o !(p4)))))). 

fof(ax1, axiom, !((!(p6) -o !((!(p6) -o !(p5)))))). 

fof(con8, conjecture, !(p0)). 
