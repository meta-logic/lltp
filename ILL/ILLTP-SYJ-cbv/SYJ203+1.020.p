...
fof(ax1, axiom, !((((!(p1) * (!(p2) * (!(p3) * (!(p4) * (!(p5) * (!(p6) * (!(p7) * (!(p8) * (!(p9) * (!(p10) * (!(p11) * (!(p12) * (!(p13) * (!(p14) * (!(p15) * (!(p16) * (!(p17) * (!(p18) * (!(p19) * !(p20)))))))))))))))))))) + (!((!(p1) -o !(f))) + (!((!(p2) -o !(f))) + (!((!(p3) -o !(f))) + (!((!(p4) -o !(f))) + (!((!(p5) -o !(f))) + (!((!(p6) -o !(f))) + (!((!(p7) -o !(f))) + (!((!(p8) -o !(f))) + (!((!(p9) -o !(f))) + (!((!(p10) -o !(f))) + (!((!(p11) -o !(f))) + (!((!(p12) -o !(f))) + (!((!(p13) -o !(f))) + (!((!(p14) -o !(f))) + (!((!(p15) -o !(f))) + (!((!(p16) -o !(f))) + (!((!(p17) -o !(f))) + (!((!(p18) -o !(f))) + (!((!(p19) -o !(f))) + !((!(p20) -o !(f))))))))))))))))))))))) -o !(f)))). 
