...
fof(ax5, axiom, !((!(a0) -o f))). 

fof(ax4, axiom, !((!((!((!((!(b3) -o 0)) -o b0)) -o 0)) -o a3))). 

fof(ax3, axiom, !((!((!((!((!(b0) -o 0)) -o a1)) -o 0)) -o a0))). 

fof(ax2, axiom, !((!((!((!((!(b1) -o 0)) -o a2)) -o 0)) -o a1))). 

fof(ax1, axiom, !((!((!((!((!(b2) -o 0)) -o a3)) -o 0)) -o a2))). 

fof(con6, conjecture, f). 
