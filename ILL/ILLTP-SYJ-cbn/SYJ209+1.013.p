...
fof(ax1, axiom, !((!((!((p1 & (p2 & (p3 & (p4 & (p5 & (p6 & (p7 & (p8 & (p9 & (p10 & (p11 & (p12 & p13))))))))))))) + !((!((!((!((!(p1) -o 0)) -o f)) -o 0)) + !((!((!(p2) -o f)) + !((!((!(p3) -o f)) + !((!((!(p4) -o f)) + !((!((!(p5) -o f)) + !((!((!(p6) -o f)) + !((!((!(p7) -o f)) + !((!((!(p8) -o f)) + !((!((!(p9) -o f)) + !((!((!(p10) -o f)) + !((!((!(p11) -o f)) + !((!((!(p12) -o f)) + !((!(p13) -o f)))))))))))))))))))))))))))) -o f))). 
