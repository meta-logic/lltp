...
fof(con1, conjecture, Modify_1_3 * Mutex_1 * Mutex_2 * Mutex_4 * WaitMutex_2_4 * WaitMutex_3_2 * WaitMutex_4_4 * all_passive_1 * all_passive_2 * all_passive_3 * all_passive_4).
