...
fof(con1, conjecture, ATTENTE_B * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CHOIX_1 * COMPTEUR_0 * NB_ATTENTE_A_0 * NB_ATTENTE_B_1 * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_B * ROUTE_B * ROUTE_B).
