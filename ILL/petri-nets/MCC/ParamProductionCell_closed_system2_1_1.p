...
fof(CU_lower_Cstop, axiom, !( (CU_lower_run * crane_release_height) -o (CU_lower_rs * crane_release_height) ) ).
...
fof(crane_lock_output_area, axiom, !( (crane_storing * ch_CF_free) -o (CU_in) ) ).
...
fof(CL_lower_csc, axiom, !( (CL_lower_run * crane_lower * crane_transport_height) -o (CL_lower_run * crane_lower * crane_pick_up_height) ) ).
...
fof(CU_lift_Cstop, axiom, !( (CU_lift_run * crane_transport_height) -o (CU_lift_rs * crane_transport_height) ) ).
fof(arm1_lock_swivel_2, axiom, !( (arm1_waiting_for_swivel_2 * swivel) -o (A1U_in) ) ).
fof(CL_lift_Cstop, axiom, !( (CL_lift_run * crane_transport_height) -o (CL_lift_rs * crane_transport_height) ) ).
...
fof(CU_lower_Pstart, axiom, !( (crane_stop_v * CU_in) -o (CU_lower_run * crane_lower) ) ).
fof(A2U_rot2_Pstop, axiom, !( (A2U_rot2_rs * robot_left) -o (robot_stop * A2U_rotated) ) ).
fof(CL_trans_Cstop, axiom, !( (CL_trans_run * crane_above_feed_belt) -o (CL_trans_rs * crane_above_feed_belt) ) ).
fof(CU_trans_csc, axiom, !( (CU_trans_run * crane_to_belt2 * crane_above_feed_belt) -o (CU_trans_run * crane_to_belt2 * crane_above_deposit_belt) ) ).
...
fof(CU_lift_Pstart, axiom, !( (crane_stop_v * CU_unloaded) -o (CU_lift_run * crane_lift) ) ).
...
fof(CL_trans_Pstop, axiom, !( (CL_trans_rs * crane_to_belt1) -o (crane_stop_h * CL_out) ) ).
...
fof(CL_grasp, axiom, !( (crane_mag_off * CL_ready_to_grasp) -o (crane_mag_on * CL_loaded) ) ).
...
fof(CU_lift_Pstop, axiom, !( (CU_lift_rs * crane_lift) -o (crane_stop_v * CU_ready_to_transport) ) ).
...
fof(CL_lift_csc, axiom, !( (CL_lift_run * crane_lift * crane_pick_up_height) -o (CL_lift_run * crane_lift * crane_transport_height) ) ).
...
fof(CL_lift_Pstop, axiom, !( (CL_lift_rs * crane_lift) -o (crane_stop_v * CL_ready_to_transport) ) ).
fof(CU_trans_Pstop, axiom, !( (CU_trans_rs * crane_to_belt2) -o (crane_stop_h * CU_out) ) ).
fof(CL_lower_Pstart, axiom, !( (crane_stop_v * CL_in) -o (CL_lower_run * crane_lower) ) ).
...
fof(CU_lower_Pstop, axiom, !( (CU_lower_rs * crane_lower) -o (crane_stop_v * CU_ready_to_ungrasp) ) ).
...
fof(CU_trans_Pstart, axiom, !( (crane_stop_h * CU_ready_to_transport) -o (CU_trans_run * crane_to_belt2) ) ).
...
fof(CU_lift_csc, axiom, !( (CU_lift_run * crane_lift * crane_release_height) -o (CU_lift_run * crane_lift * crane_transport_height) ) ).
fof(arm2_lock_swivel_2, axiom, !( (arm2_waiting_for_swivel_2 * swivel) -o (A2U_in) ) ).
fof(CU_trans_Cstop, axiom, !( (CU_trans_run * crane_above_deposit_belt) -o (CU_trans_rs * crane_above_deposit_belt) ) ).
...
fof(CU_lower_csc, axiom, !( (CU_lower_run * crane_lower * crane_transport_height) -o (CU_lower_run * crane_lower * crane_release_height) ) ).
...
fof(crane_lock_input_area, axiom, !( (crane_store_free * ch_DC_full) -o (CL_in) ) ).
...
fof(CL_trans_csc, axiom, !( (CL_trans_run * crane_to_belt1 * crane_above_deposit_belt) -o (CL_trans_run * crane_to_belt1 * crane_above_feed_belt) ) ).
...
fof(CU_ungrasp, axiom, !( (crane_mag_on * CU_ready_to_ungrasp) -o (crane_mag_off * CU_unloaded) ) ).
...
fof(crane_unlock_output_area, axiom, !( (CU_out) -o (crane_store_free * ch_CF_full) ) ).
...
fof(CL_lift_Pstart, axiom, !( (crane_stop_v * CL_loaded) -o (CL_lift_run * crane_lift) ) ).
...
fof(CL_lower_Pstop, axiom, !( (CL_lower_rs * crane_lower) -o (crane_stop_v * CL_ready_to_grasp) ) ).
fof(TU_rot_Pstop, axiom, !( (TU_rot_rs * table_right) -o (table_stop_h * table_at_unload_angle) ) ).
fof(CL_lower_Cstop, axiom, !( (CL_lower_run * crane_pick_up_height) -o (CL_lower_rs * crane_pick_up_height) ) ).
fof(CL_trans_Pstart, axiom, !( (crane_stop_h * CL_ready_to_transport) -o (CL_trans_run * crane_to_belt1) ) ).
fof(A2L_ret_csc, axiom, !( (A2L_ret_run * arm2_pick_up_ext * arm2_backward) -o (A2L_ret_run * arm2_retract_ext * arm2_backward) ) ).
fof(crane_unlock_input_area, axiom, !( (CL_out) -o (crane_storing * ch_DC_free) ) ).
...
fof(con1, conjecture, arm1_magnet_off * arm1_retract_ext * arm1_stop * arm1_store_free * arm2_magnet_off * arm2_release_angle * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A1P_free * ch_A2D_free * ch_DC_full * ch_FT_free * crane_above_deposit_belt * crane_mag_off * crane_stop_h * crane_stop_v * crane_store_free * crane_transport_height * deposit_belt_idle * feed_belt_occupied * press_at_middle_pos * press_ready_for_loading * press_stop * robot_stop * swivel * table_bottom_pos * table_load_angle * table_ready_for_loading * table_stop_h * table_stop_v).
