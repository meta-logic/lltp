...
fof(con1, conjecture, ATTENTE_A * ATTENTE_B * CAPACITE * CAPACITE * CAPACITE * CAPACITE * COMPTEUR_0 * NB_ATTENTE_A_1 * NB_ATTENTE_B_1 * ROUTE_A * ROUTE_B * SORTI_A * SORTI_A * SORTI_B * SUR_PONT_B * VIDANGE_1).
