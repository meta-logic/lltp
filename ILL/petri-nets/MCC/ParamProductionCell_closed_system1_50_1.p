...
fof(con1, conjecture, TU_lift_rs * arm1_magnet_off * arm1_retract_ext * arm1_stop * arm1_store_free * arm2_magnet_off * arm2_release_angle * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A1P_free * ch_A2D_free * ch_CF_free * ch_DC_free * crane_above_deposit_belt * crane_mag_off * crane_stop_h * crane_stop_v * crane_store_free * crane_transport_height * deposit_belt_idle * feed_belt_idle * press_at_middle_pos * press_ready_for_loading * press_stop * robot_stop * swivel * table_stop_h * table_top_pos * table_unload_angle * table_upward).
