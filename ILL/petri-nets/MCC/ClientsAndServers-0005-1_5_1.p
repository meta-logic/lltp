...
fof(con1, conjecture, CR * CR * CR * CR * CR * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * CwG * CwG * CwG * CwG * CwG * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Si * Si * Si * Si * Si * Si * Si * Si * Si * Si * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf).
