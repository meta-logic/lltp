...
fof(con1, conjecture, Mutex_1 * Mutex_2 * Mutex_3 * Mutex_4 * WaitMutex_1_3 * all_active_2 * all_active_3 * all_active_4 * all_passive_1 * all_passive_2 * all_passive_3 * all_passive_4).
