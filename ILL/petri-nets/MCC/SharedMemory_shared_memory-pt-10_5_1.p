...
fof(con1, conjecture, Active_1 * Active_10 * Active_2 * Active_3 * Active_4 * Active_9 * Ext_Mem_Acc_8_9 * Memory_1 * Memory_10 * Memory_2 * Memory_3 * Memory_4 * Memory_5 * Memory_6 * Memory_7 * Memory_8 * OwnMemAcc_6 * OwnMemAcc_7 * Queue_5).
