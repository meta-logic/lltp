...
fof(con1, conjecture, P-client_idle_1 * P-client_waiting_2 * P-lb_load_1_0 * P-lb_load_2_0 * P-lb_routing_1_2 * P-server_idle_2 * P-server_notification_ack_1 * P-server_waiting_1).
