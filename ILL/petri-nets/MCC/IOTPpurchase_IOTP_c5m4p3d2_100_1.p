...
%--------------------------------------------------------------------------
fof(inital_state, axiom, ConsumerOffer_p1 * ConsumerOffer_p1 * ConsumerOffer_p1 * ConsumerOffer_p1 * ConsumerOffer_p1 * DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * MerchantOffer_p2 * MerchantOffer_p2 * MerchantOffer_p2 * MerchantOffer_p2 * OfferResponce_p10 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7).
...
fof(con1, conjecture, DeliveryHandlerDelivery_p8_0 * Delivery_p22_8 * OfferResponce_p10 * Order_p22_10 * Organization_p21_2 * Organization_p21_2 * Organization_p21_2 * Organization_p22_9 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * Payment_p21_1 * Payment_p21_1 * Payment_p21_1 * Status_p22_11 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7 * p3_2 * p3_5 * p3_5 * p3_5 * p4_1 * p4_5 * p4_5 * p4_5 * p6_5 * p8_1).
