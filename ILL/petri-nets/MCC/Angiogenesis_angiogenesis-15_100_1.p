...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarPgStar * KdStarGStarPgStar * KdStarPgStar * KdStarPgStar * KdStarPgStar * KdStarPgStar * P3k * P3k * P3k * P3k * P3k * P3k * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pip2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * Pten).
