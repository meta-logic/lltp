...
fof(con1, conjecture, AvailableJobId_1 * AvailableJobId_2 * AvailableJobId_3 * AvailableJobId_4 * AwakeTasks_5 * BlockedTasks * CreatedJobs_0_1 * DataOnSrc_2 * IdleTasks_10 * IdleTasks_2 * IdleTasks_3 * IdleTasks_4 * IdleTasks_6 * IdleTasks_7 * IdleTasks_8 * IdleTasks_9 * Idle_10 * Idle_2 * Idle_3 * Idle_4 * Idle_5 * Idle_6 * Idle_7 * Idle_8 * Idle_9 * IsMonitoring * JobCnt * MarkerRead * NoSigAbort * NotifyEventJobQueuedE_1 * P_1093 * P_1725_0 * P_1727 * PlaceSources_2 * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cIdleTasks * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cPollingAbort).
