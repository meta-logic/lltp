...
fof(con1, conjecture, ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * F6P * G6P * GAP * GSH * GSH * NADPH * NADPH * NADplus * NADplus * Pi * Pi * Pi * Pi * Pi * Pi * Pi * S7P * a1 * a2 * b1 * b1 * b2 * c1 * c1 * c1 * c1 * c1 * c1 * c1).
