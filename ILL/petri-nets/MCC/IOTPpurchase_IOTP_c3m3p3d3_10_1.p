...
fof(con1, conjecture, DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * Delivery_p20 * OfferResponce_p10 * Order_p20 * Organization_p20_2 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * Payment_p20 * Status_p20 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7 * p1_2 * p1_2 * p1_2 * p2_1 * p2_1 * p2_2).
