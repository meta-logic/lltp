...
%--------------------------------------------------------------------------
fof(inital_state, axiom, P1 * P1 * P1 * P1 * P1 * M1 * M1 * M1 * P2 * P2 * P2 * P2 * P2 * M2 * M3 * M3 * P3 * P3 * P3 * P3 * P3).
...
fof(con1, conjecture, M1 * M1 * M1 * M2 * M3 * M3 * P1wM1 * P1wM1 * P1wM1 * P1wM1 * P1wM1 * P2d * P2wM2 * P2wM2 * P2wM2 * P2wP1 * P3M2 * P3M2 * P3M2 * P3M2 * P3M2).
