...
fof(con1, conjecture, AMC_1_1 * Cpt1_2 * Cpt2_1 * FMC_1 * S_tout * cable_used_1 * loop_em_10 * msgl_1 * msgl_10 * msgl_11 * msgl_12 * msgl_13 * msgl_14 * msgl_15 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_cable_1 * wait_msg_11 * wait_msg_12 * wait_msg_13 * wait_msg_14 * wait_msg_15 * wait_msg_2 * wait_msg_3 * wait_msg_4 * wait_msg_5 * wait_msg_6 * wait_msg_7 * wait_msg_8 * wait_msg_9).
