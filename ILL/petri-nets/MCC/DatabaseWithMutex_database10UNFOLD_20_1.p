...
fof(con1, conjecture, Active_1_1 * Mutex_10 * Mutex_2 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * RecBuff_9_1 * all_active_10 * all_active_2 * all_active_3 * all_active_4 * all_active_5 * all_active_6 * all_active_7 * all_active_8 * all_active_9 * all_passive_1 * all_passive_9 * updating_10_1 * updating_2_1 * updating_3_1 * updating_4_1 * updating_5_1 * updating_6_1 * updating_7_1 * updating_8_1).
