...
fof(con1, conjecture, AvailableJobId_2 * AvailableJobId_3 * AvailableJobId_4 * BlockedTasks * CanInjectEvent * Check_Sources_B_3 * CreatedJobs_0_1 * CreatedJobs_1_2 * IdleTasks_4 * IdleTasks_5 * IdleTasks_6 * Idle_4 * Idle_5 * Idle_6 * IsMonitoring * JobCnt * JobCnt * NoSigAbort * NotifyEventJobCompletedB_1 * P_1712_0 * P_1716 * P_1725_1 * P_1727 * RunE_2 * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cIdleTasks * cIdleTasks * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cPollingAbort * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources).
