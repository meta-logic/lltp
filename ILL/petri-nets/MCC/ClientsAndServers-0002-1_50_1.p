...
fof(con1, conjecture, CF * CG * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CwA * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * Mi * Mi * Mi * Si * SpG * SpG * SpG * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf).
