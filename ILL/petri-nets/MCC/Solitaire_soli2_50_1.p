...
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
fof(inital_state, axiom, T31 * T51 * T42 * T53 * T62 * T52 * T43 * T32 * T41 * T22 * T33 * T34 * p25 * T14 * T23 * F13 * T15 * T44 * T35 * T24 * T45 * T54 * T73 * T75 * T64 * T55 * T63 * T65 * T74 * T46 * T37 * T26 * T36 * T47 * T56 * T66 * T57).
...
fof(left24, axiom, !( (T24 * T23 * F25) -o (F24 * F23 * p25) ) ).
fof(right24, axiom, !( (T24 * p25 * F23) -o (F24 * F25 * T23) ) ).
...
fof(up23, axiom, !( (T23 * T13 * F33) -o (F23 * F13 * T33) ) ).
fof(down23, axiom, !( (T23 * T33 * F13) -o (F23 * F33 * T13) ) ).
...
fof(left25, axiom, !( (p25 * T24 * F26) -o (F25 * F24 * T26) ) ).
fof(right25, axiom, !( (p25 * T26 * F24) -o (F25 * F26 * T24) ) ).
fof(up25, axiom, !( (p25 * T15 * F35) -o (F25 * F15 * T35) ) ).
fof(down25, axiom, !( (p25 * T35 * F15) -o (F25 * F35 * T15) ) ).
fof(left35, axiom, !( (T35 * T34 * F36) -o (F35 * F34 * T36) ) ).
fof(right35, axiom, !( (T35 * T36 * F34) -o (F35 * F36 * T34) ) ).
fof(up35, axiom, !( (T35 * p25 * F45) -o (F35 * F25 * T45) ) ).
fof(down35, axiom, !( (T35 * T45 * F25) -o (F35 * F45 * p25) ) ).
...
fof(con1, conjecture, F14 * F15 * F22 * F23 * F24 * F25 * F26 * F32 * F33 * F34 * F35 * F36 * F41 * F42 * F43 * F44 * F46 * F47 * F51 * F52 * F53 * F54 * F55 * F56 * F62 * F63 * F65 * F66 * F73 * F74 * T13 * T31 * T37 * T45 * T57 * T64 * T75).
