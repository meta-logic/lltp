...
fof(con1, conjecture, Active_1_1 * Mutex_10 * Mutex_11 * Mutex_12 * Mutex_13 * Mutex_14 * Mutex_15 * Mutex_16 * Mutex_17 * Mutex_18 * Mutex_19 * Mutex_2 * Mutex_20 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * WaitMutex_10_1 * WaitMutex_11_1 * WaitMutex_12_1 * WaitMutex_13_1 * WaitMutex_14_1 * WaitMutex_15_1 * WaitMutex_16_1 * WaitMutex_17_1 * WaitMutex_18_1 * all_active_19 * all_active_2 * all_active_20 * all_active_3 * all_active_4 * all_active_5 * all_active_6 * all_active_7 * all_active_8 * all_active_9 * all_passive_1 * updating_10_1 * updating_11_1 * updating_12_1 * updating_13_1 * updating_14_1 * updating_15_1 * updating_16_1 * updating_17_1 * updating_18_1 * updating_19_1 * updating_20_1 * updating_2_1 * updating_3_1 * updating_4_1 * updating_5_1 * updating_6_1 * updating_7_1 * updating_8_1 * updating_9_1).
