...
fof(con1, conjecture, A2L_loaded * FB_at_end * arm1_magnet_off * arm1_retract_ext * arm1_stop * arm1_store_free * arm2_magnet_on * arm2_pick_up_angle * arm2_pick_up_ext * arm2_stop * belt1_light_barrier_true * belt1_stop * belt2_light_barrier_false * belt2_stop * c_p1 * ch_A2D_free * ch_DC_free * deposit_belt_idle * p_p1 * press_at_lower_pos * press_ready_for_unloading * press_stop * robot_stop * table_bottom_pos * table_load_angle * table_ready_for_loading * table_stop_h * table_stop_v).
