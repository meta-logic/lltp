...
fof(con1, conjecture, p10 * p100 * p105 * p110 * p115 * p120 * p125 * p130 * p131 * p140 * p143 * p15 * p150 * p155 * p160 * p165 * p170 * p175 * p180 * p181 * p187 * p20 * p25 * p30 * p35 * p38 * p45 * p5 * p50 * p55 * p57 * p65 * p70 * p75 * p80 * p85 * p90 * p95).
