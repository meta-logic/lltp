...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten).
