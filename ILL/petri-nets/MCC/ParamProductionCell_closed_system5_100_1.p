...
fof(con1, conjecture, A2L_loaded * TU_in * arm1_magnet_on * arm1_retract_ext * arm1_stop * arm1_storing * arm2_magnet_on * arm2_pick_up_angle * arm2_pick_up_ext * arm2_stop * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A2D_free * ch_CF_free * ch_DC_full * crane_above_feed_belt * crane_mag_on * crane_stop_h * crane_stop_v * crane_storing * crane_transport_height * deposit_belt_idle * feed_belt_idle * press_at_lower_pos * press_ready_for_unloading * press_stop * robot_stop * table_bottom_pos * table_load_angle * table_stop_h * table_stop_v).
