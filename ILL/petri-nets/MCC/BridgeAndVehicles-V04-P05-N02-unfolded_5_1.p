...
fof(con1, conjecture, ATTENTE_B * CAPACITE * CAPACITE * CAPACITE * CAPACITE * COMPTEUR_2 * CONTROLEUR_1 * NB_ATTENTE_A_0 * NB_ATTENTE_B_1 * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_B * ROUTE_B * ROUTE_B * SUR_PONT_A).
