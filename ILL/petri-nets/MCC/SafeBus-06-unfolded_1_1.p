...
fof(con1, conjecture, AMC_3_1 * Cpt1_2 * Cpt2_1 * FMCb * R_tout * cable_free * listen_1 * listen_2 * listen_4 * listen_5 * listen_6 * msgl_1 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * wait_cable_3).
