...
fof(con1, conjecture, Catch2_5 * Fork_1 * Fork_10 * Fork_2 * Fork_3 * Fork_4 * Fork_6 * Fork_7 * Fork_8 * Fork_9 * Think_1 * Think_10 * Think_2 * Think_3 * Think_4 * Think_6 * Think_7 * Think_8 * Think_9).
