...
fof(con1, conjecture, AMC_6_1 * Cpt1_2 * Cpt2_1 * FMCb * R_tout * cable_free * listen_1 * listen_10 * listen_2 * listen_3 * listen_4 * listen_5 * listen_7 * listen_8 * listen_9 * msgl_1 * msgl_10 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_cable_6).
