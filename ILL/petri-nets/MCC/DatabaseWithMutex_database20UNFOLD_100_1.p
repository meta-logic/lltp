...
fof(con1, conjecture, Modify_10_1 * Mutex_10 * Mutex_11 * Mutex_12 * Mutex_13 * Mutex_14 * Mutex_15 * Mutex_16 * Mutex_17 * Mutex_18 * Mutex_19 * Mutex_2 * Mutex_20 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * WaitMutex_11_1 * WaitMutex_12_1 * WaitMutex_13_1 * WaitMutex_14_1 * WaitMutex_15_1 * WaitMutex_16_1 * WaitMutex_17_1 * WaitMutex_18_1 * WaitMutex_19_1 * WaitMutex_20_1 * WaitMutex_2_1 * WaitMutex_3_1 * WaitMutex_4_1 * WaitMutex_5_1 * WaitMutex_6_1 * WaitMutex_7_1 * WaitMutex_8_1 * WaitMutex_9_1 * all_active_1 * all_passive_1 * all_passive_10 * all_passive_11 * all_passive_12 * all_passive_13 * all_passive_14 * all_passive_15 * all_passive_16 * all_passive_17 * all_passive_18 * all_passive_19 * all_passive_2 * all_passive_20 * all_passive_3 * all_passive_4 * all_passive_5 * all_passive_6 * all_passive_7 * all_passive_8 * all_passive_9).
