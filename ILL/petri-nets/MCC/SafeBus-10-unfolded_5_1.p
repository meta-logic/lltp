...
fof(con1, conjecture, AMC_10_5 * AMC_4_2 * AMC_5_3 * AMC_6_1 * AMC_8_4 * Cpt1_6 * Cpt2_1 * FMCb * R_tout * cable_free * listen_1 * listen_2 * listen_3 * listen_7 * listen_9 * msgl_1 * msgl_10 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_cable_10 * wait_cable_4 * wait_cable_5 * wait_cable_6 * wait_cable_8).
