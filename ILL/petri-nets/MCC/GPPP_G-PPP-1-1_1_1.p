...
fof(con1, conjecture, ADP * ADP * ADP * ADP * ADP * ADP * ADP * ATP * ATP * ATP * ATP * GSSG * Gluc * Gluc * Gluc * Gluc * NADPplus * NADPplus * NADplus * NADplus * Pi * Pi * Pi * Pi * Pi * Pi * Pi * a1 * a1 * b1 * b1 * b1 * c1 * c1 * c1 * c1 * c1 * c1 * c1).
