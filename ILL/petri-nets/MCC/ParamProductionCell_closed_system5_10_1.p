...
fof(con1, conjecture, CL_lower_run * arm1_magnet_off * arm1_retract_ext * arm1_stop * arm1_store_free * arm2_magnet_off * arm2_release_angle * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A1P_full * crane_above_deposit_belt * crane_lower * crane_mag_off * crane_pick_up_height * crane_stop_h * deposit_belt_occupied * feed_belt_occupied * press_at_middle_pos * press_ready_for_loading * press_stop * robot_stop * swivel * table_at_unload_angle * table_bottom_pos * table_stop_h * table_stop_v * table_unload_angle).
