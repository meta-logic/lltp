...
fof(con1, conjecture, Client_Waiting_1 * Client_Waiting_2 * Client_Waiting_3 * Client_Waiting_4 * Client_Waiting_5 * Client_Waiting_6 * Client_Waiting_7 * Client_Waiting_8 * Client_Waiting_9 * RequestBufferSlots * RequestBufferSlots * RequestBufferSlots * Server_Anwering_1_1 * Server_Waiting_2 * Server_Waiting_3).
