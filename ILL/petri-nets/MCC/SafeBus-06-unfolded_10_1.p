...
fof(con1, conjecture, AMC_2_6 * AMC_5_5 * AMC_6_4 * Cpt1_1 * Cpt2_4 * FMCb * MSG_2 * RMC_1 * RMC_4 * R_tout * cable_used_3 * msgl_1 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * wait_ack_3_2 * wait_cable_1 * wait_cable_2 * wait_cable_4 * wait_cable_5 * wait_cable_6).
