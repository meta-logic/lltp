...
fof(con1, conjecture, CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * SYN * SYNSENT * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED).
