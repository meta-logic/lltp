...
fof(con1, conjecture, CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * COMPTEUR_2 * CONTROLEUR_1 * NB_ATTENTE_A_0 * NB_ATTENTE_B_0 * SORTI_A * SORTI_A * SORTI_A * SORTI_A * SORTI_B * SORTI_B * SORTI_B * SORTI_B).
