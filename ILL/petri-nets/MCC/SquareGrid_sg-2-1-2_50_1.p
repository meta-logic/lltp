...
fof(con1, conjecture, p1i_0 * p1i_1_2 * p1il_2_1 * p1il_2_2 * p1o_1_1 * p1o_1_2 * p1o_2_1 * p1o_2_2 * p2i_2_2 * p2il_1_2 * p2o_1_2 * p2ol_2_2 * p3il_2_1 * p3il_2_2 * p3ol_2_1 * p3ol_2_2 * p4i_1_1 * p4i_2_1 * p4i_2_2 * p4il_1_2 * p4ol_1_1 * p4ol_1_2 * p4ol_2_1 * p4ol_2_2 * pb1_1_2 * pb1_2_1 * pb1_2_2 * pb1_2_2 * pb2_1_1 * pbl_1_1 * pbl_1_1 * pbl_1_1 * pbl_1_1 * pbl_1_1 * pbl_1_2 * pbl_1_2 * pbl_1_2 * pbl_1_2 * pbl_1_2 * pbl_2_1 * pbl_2_1 * pbl_2_1 * pbl_2_1 * pbl_2_1 * pbl_2_2 * pbl_2_2 * pbl_2_2 * pbl_2_2).
