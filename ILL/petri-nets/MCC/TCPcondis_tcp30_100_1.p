...
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
fof(inital_state, axiom, CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * CLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED).
...
fof(con1, conjecture, FINWAIT1 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xFINACK).
