...
fof(con1, conjecture, P-client_idle_5 * P-client_request_4 * P-client_waiting_1 * P-client_waiting_2 * P-client_waiting_3 * P-client_waiting_4 * P-lb_idle_1 * P-lb_load_1_2 * P-lb_load_2_2 * P-server_notification_ack_2 * P-server_processed_1 * P-server_request_1_1 * P-server_request_2_2 * P-server_request_3_2 * P-server_waiting_2).
