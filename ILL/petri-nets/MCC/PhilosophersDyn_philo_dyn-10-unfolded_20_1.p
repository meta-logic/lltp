...
fof(con1, conjecture, Neighbourhood_2_3 * Neighbourhood_3_2 * Outside_1 * Outside_10 * Outside_4 * Outside_5 * Outside_6 * Outside_7 * Outside_8 * Outside_9 * WaitLeft_2 * WaitLeft_3 * WaitRight_2 * WaitRight_3).
