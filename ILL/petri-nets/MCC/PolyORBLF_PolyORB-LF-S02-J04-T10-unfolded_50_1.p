...
fof(con1, conjecture, Abort_Check_Sources_E_5 * AbourtToModifySrc_1 * AvailableJobId_1 * AvailableJobId_2 * AvailableJobId_3 * AvailableJobId_4 * CanInjectEvent * CreatedJobs_0_2 * IdleTasks_10 * IdleTasks_2 * IdleTasks_3 * IdleTasks_4 * IdleTasks_6 * IdleTasks_7 * IdleTasks_8 * IdleTasks_9 * Idle_10 * Idle_2 * Idle_3 * Idle_4 * Idle_6 * Idle_7 * Idle_8 * Idle_9 * P_1716 * P_1726 * PollingAbort * ScheduleTaskE_Work_1_0 * SigAbort * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cIdleTasks * cIsMonitoring * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources).
