...
fof(con1, conjecture, CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * MpG * MpG * SR * Si * Si * Si * Si * Si * Si * Si * SwG * SwG * SwG * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf).
