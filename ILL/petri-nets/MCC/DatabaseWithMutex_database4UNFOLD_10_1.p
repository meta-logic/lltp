...
fof(con1, conjecture, Active_1_3 * Active_2_4 * Message_1_4 * Message_3_3 * Message_3_4 * Message_4_3 * Mutex_1 * Mutex_2 * RecBuff_2_3 * RecBuff_4_4 * WaitMutex_3_2 * WaitMutex_4_4 * all_passive_1 * all_passive_2 * all_passive_3 * all_passive_4).
