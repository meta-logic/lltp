...
fof(con1, conjecture, Modify_1_1 * Mutex_2 * Mutex_3 * Mutex_4 * WaitMutex_3_1 * WaitMutex_4_1 * all_active_2 * all_passive_1 * all_passive_2 * all_passive_3 * all_passive_4).
