...
fof(con1, conjecture, F13 * F14 * F14 * F15 * F16 * F17 * F17 * F2 * F2 * F20 * F23 * F3 * F4 * F5 * F5 * F6 * Section_1 * Section_11 * Section_12 * Section_19 * Section_21 * Section_23 * Section_8 * Section_9).
