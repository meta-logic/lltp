...
fof(con1, conjecture, A1U_rot1_run * TL_rot_run * arm1_magnet_on * arm1_pick_up_angle * arm1_retract_ext * arm1_stop * arm2_magnet_off * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A2D_free * ch_DC_free * crane_above_feed_belt * crane_mag_on * crane_stop_h * crane_stop_v * crane_storing * crane_transport_height * deposit_belt_idle * feed_belt_occupied * press_at_middle_pos * press_ready_for_loading * press_stop * robot_right * table_right * table_stop_v * table_top_pos * table_unload_angle).
