...
fof(con1, conjecture, A2L_loaded * CU_lift_rs * TU_rot_rs * arm1_magnet_on * arm1_retract_ext * arm1_stop * arm1_storing * arm2_magnet_on * arm2_pick_up_angle * arm2_pick_up_ext * arm2_stop * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_stop * ch_A2D_free * ch_DC_free * crane_above_feed_belt * crane_lift * crane_mag_off * crane_stop_h * crane_transport_height * deposit_belt_idle * feed_belt_idle * press_at_lower_pos * press_ready_for_unloading * press_stop * robot_stop * table_bottom_pos * table_right * table_stop_v * table_unload_angle).
