...
fof(con1, conjecture, p1 * p101 * p106 * p11 * p111 * p116 * p121 * p126 * p131 * p136 * p141 * p146 * p155 * p160 * p165 * p170 * p172 * p180 * p184 * p187 * p20 * p21 * p26 * p35 * p40 * p45 * p50 * p55 * p6 * p60 * p65 * p70 * p75 * p80 * p85 * p90 * p95 * p96).
