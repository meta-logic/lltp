...
fof(con1, conjecture, CR * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * CwG * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Mi * Si * Si * Si * Si * Si * Si * Si * Si * Si * Si * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf).
