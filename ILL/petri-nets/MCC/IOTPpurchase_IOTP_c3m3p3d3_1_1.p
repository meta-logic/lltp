...
fof(con1, conjecture, ConsumerOffer_p1 * ConsumerOffer_p1 * DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * MerchantOffer_p2 * MerchantOffer_p2 * MerchantOffer_p2 * OfferResponce_p10 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7 * p1_1).
