...
%--------------------------------------------------------------------------
fof(inital_state, axiom, Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStar * KdStar * KdStar * KdStar * KdStar * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * P3k * P3k * P3k * P3k * P3k * Pg * Pg * Pg * Pg * Pg * Pten * Pten * Pten * Pten * Pten).
...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStarPgStar * KdStarPgStar * KdStarPgStar * KdStarPgStar * KdStarPgStar * P3k * P3k * P3k * P3k * P3k * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pten * Pten * Pten * Pten * Pten).
