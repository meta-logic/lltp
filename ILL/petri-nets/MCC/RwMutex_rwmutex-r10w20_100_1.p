...
fof(con1, conjecture, p10 * p11 * p12 * p13 * p14 * p15 * p16 * p17 * p18 * p19 * p2 * p20 * p21 * p22 * p23 * p24 * p25 * p26 * p27 * p28 * p29 * p3 * p30 * p31 * p4 * p42 * p43 * p44 * p45 * p46 * p47 * p48 * p49 * p5 * p50 * p51 * p6 * p7 * p8 * p9).
