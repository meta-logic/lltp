...
fof(con1, conjecture, Active_1_1 * Message_19_1 * Message_20_1 * Message_2_1 * Message_3_1 * Message_4_1 * Message_5_1 * Message_6_1 * Message_7_1 * Message_8_1 * Message_9_1 * Mutex_10 * Mutex_11 * Mutex_12 * Mutex_13 * Mutex_14 * Mutex_15 * Mutex_16 * Mutex_17 * Mutex_18 * Mutex_19 * Mutex_2 * Mutex_20 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * RecBuff_18_1 * all_active_10 * all_active_11 * all_active_12 * all_active_13 * all_active_14 * all_active_15 * all_active_16 * all_active_17 * all_active_18 * all_active_19 * all_active_2 * all_active_20 * all_active_3 * all_active_4 * all_active_5 * all_active_6 * all_active_7 * all_active_8 * all_active_9 * all_passive_1 * all_passive_18 * all_passive_19 * all_passive_2 * all_passive_20 * all_passive_3 * all_passive_4 * all_passive_5 * all_passive_6 * all_passive_7 * all_passive_8 * all_passive_9 * updating_10_1 * updating_11_1 * updating_12_1 * updating_13_1 * updating_14_1 * updating_15_1 * updating_16_1 * updating_17_1).
