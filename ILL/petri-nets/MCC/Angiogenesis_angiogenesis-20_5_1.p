...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStar * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pg * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pip2 * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten * Pten).
