...
fof(con1, conjecture, Active_1_1 * Message_6_1 * Message_7_1 * Message_8_1 * Message_9_1 * Mutex_10 * Mutex_2 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * RecBuff_5_1 * WaitMutex_2_1 * WaitMutex_3_1 * WaitMutex_4_1 * WaitMutex_5_1 * WaitMutex_6_1 * WaitMutex_7_1 * WaitMutex_8_1 * WaitMutex_9_1 * all_active_10 * all_passive_1 * all_passive_5 * all_passive_6 * all_passive_7 * all_passive_8 * all_passive_9 * updating_10_1 * updating_2_1 * updating_3_1 * updating_4_1).
