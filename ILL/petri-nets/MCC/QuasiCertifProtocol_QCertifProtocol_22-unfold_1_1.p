...
fof(con1, conjecture, Astart * Cstart_0 * Cstart_1 * Cstart_10 * Cstart_11 * Cstart_12 * Cstart_13 * Cstart_14 * Cstart_15 * Cstart_16 * Cstart_17 * Cstart_18 * Cstart_19 * Cstart_2 * Cstart_20 * Cstart_21 * Cstart_22 * Cstart_3 * Cstart_4 * Cstart_5 * Cstart_6 * Cstart_7 * Cstart_8 * Cstart_9 * Sstart_1 * Sstart_10 * Sstart_11 * Sstart_12 * Sstart_13 * Sstart_14 * Sstart_15 * Sstart_16 * Sstart_17 * Sstart_18 * Sstart_19 * Sstart_2 * Sstart_20 * Sstart_21 * Sstart_22 * Sstart_3 * Sstart_4 * Sstart_5 * Sstart_6 * Sstart_7 * Sstart_8 * Sstart_9 * SstopAbort * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir).
