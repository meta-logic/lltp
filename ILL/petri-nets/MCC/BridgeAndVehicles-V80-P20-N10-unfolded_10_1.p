...
fof(con1, conjecture, ATTENTE_A * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * COMPTEUR_3 * CONTROLEUR_1 * NB_ATTENTE_A_1 * NB_ATTENTE_B_0 * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * ROUTE_B * SORTI_A * SORTI_A).
