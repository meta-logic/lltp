...
fof(con1, conjecture, FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * LISTEN * xCLOSED * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT).
