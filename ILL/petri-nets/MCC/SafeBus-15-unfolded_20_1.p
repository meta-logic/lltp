...
fof(con1, conjecture, AMC_13_5 * AMC_14_6 * AMC_15_7 * AMC_2_8 * AMC_3_9 * AMC_4_10 * AMC_5_11 * AMC_6_12 * AMC_7_13 * AMC_8_14 * AMC_9_15 * Cpt1_1 * Cpt2_5 * FMCb * MSG_10 * RMC_10 * RMC_11 * RMC_12 * R_tout * cable_used_1 * msgl_1 * msgl_10 * msgl_11 * msgl_12 * msgl_13 * msgl_14 * msgl_15 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_ack_1_10 * wait_cable_10 * wait_cable_11 * wait_cable_12 * wait_cable_13 * wait_cable_14 * wait_cable_15 * wait_cable_2 * wait_cable_3 * wait_cable_4 * wait_cable_5 * wait_cable_6 * wait_cable_7 * wait_cable_8 * wait_cable_9).
