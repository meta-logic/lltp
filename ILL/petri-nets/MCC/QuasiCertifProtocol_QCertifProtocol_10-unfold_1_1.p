...
fof(con1, conjecture, Astart * Cstart_0 * Cstart_1 * Cstart_10 * Cstart_2 * Cstart_3 * Cstart_4 * Cstart_5 * Cstart_6 * Cstart_7 * Cstart_8 * Cstart_9 * Sstart_0 * Sstart_1 * Sstart_10 * Sstart_2 * Sstart_4 * Sstart_5 * Sstart_6 * Sstart_7 * Sstart_8 * Sstart_9 * SstopAbort * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir).
