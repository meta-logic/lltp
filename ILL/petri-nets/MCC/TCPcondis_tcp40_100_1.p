...
fof(con1, conjecture, FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * FINWAIT2 * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYN * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * SYNSENT * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSED * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT * xCLOSEWAIT).
