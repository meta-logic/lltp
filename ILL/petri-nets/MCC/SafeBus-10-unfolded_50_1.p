...
fof(con1, conjecture, AMC_10_4 * AMC_1_3 * Cpt1_5 * Cpt2_3 * FMCb * R_tout * cable_free * msgl_1 * msgl_10 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_cable_1 * wait_cable_10 * wait_msg_2 * wait_msg_3 * wait_msg_4 * wait_msg_5 * wait_msg_6 * wait_msg_7 * wait_msg_8 * wait_msg_9).
