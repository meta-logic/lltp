...
fof(con1, conjecture, AMC_1_5 * AMC_2_6 * Cpt1_1 * Cpt2_5 * FMCb * R_tout * cable_free * msgl_1 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * wait_cable_1 * wait_cable_2 * wait_msg_3 * wait_msg_4 * wait_msg_5 * wait_msg_6).
