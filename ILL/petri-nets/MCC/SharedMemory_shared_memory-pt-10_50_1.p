...
fof(con1, conjecture, Active_2 * Ext_Mem_Acc_10_1 * Memory_10 * Memory_2 * Memory_3 * Memory_4 * Memory_5 * Memory_6 * Memory_7 * Memory_8 * Memory_9 * OwnMemAcc_1 * Queue_3 * Queue_4 * Queue_5 * Queue_6 * Queue_7 * Queue_8 * Queue_9).
