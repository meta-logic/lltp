...
fof(con1, conjecture, Active_7 * Active_8 * Active_9 * Ext_Mem_Acc_1_10 * Memory_1 * Memory_2 * Memory_3 * Memory_4 * Memory_5 * Memory_6 * Memory_7 * Memory_8 * Memory_9 * OwnMemAcc_10 * Queue_2 * Queue_3 * Queue_4 * Queue_5 * Queue_6).
