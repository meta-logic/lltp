...
fof(con1, conjecture, Client_Sending_15 * Client_Sending_3 * Client_Sending_6 * Client_Waiting_1 * Client_Waiting_10 * Client_Waiting_11 * Client_Waiting_12 * Client_Waiting_13 * Client_Waiting_14 * Client_Waiting_16 * Client_Waiting_2 * Client_Waiting_4 * Client_Waiting_5 * Client_Waiting_7 * Client_Waiting_8 * Client_Waiting_9 * RequestBufferSlots * RequestBufferSlots * RequestBufferSlots * RequestBufferSlots * Server_Anwering_15_3 * Server_Waiting_1 * Server_Waiting_2 * Server_Waiting_4).
