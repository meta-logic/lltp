...
fof(con1, conjecture, Abort_Check_Sources_E_5 * AbourtToModifySrc_1 * AvailableJobId_0 * AvailableJobId_1 * AvailableJobId_2 * AvailableJobId_3 * AvailableJobId_4 * CanInjectEvent * IdleTasks_2 * IdleTasks_3 * IdleTasks_4 * Idle_2 * Idle_3 * Idle_4 * NoSigAbort * P_1716 * P_1726 * P_2579_6_2 * PollingAbort * ScheduleTaskB_1 * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cIdleTasks * cIdleTasks * cIsMonitoring * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources * cSources).
