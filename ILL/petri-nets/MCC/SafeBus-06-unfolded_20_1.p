...
fof(con1, conjecture, Cpt1_1 * Cpt2_1 * FMCb * MSG_2 * S_tout * cable_used_1 * msgl_1 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * wait_ack_1_2 * wait_msg_2 * wait_msg_3 * wait_msg_4 * wait_msg_5 * wait_msg_6).
