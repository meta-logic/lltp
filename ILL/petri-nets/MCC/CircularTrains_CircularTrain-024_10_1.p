...
fof(con1, conjecture, F13 * F14 * F16 * F17 * F17 * F18 * F19 * F2 * F20 * F23 * F4 * F5 * F5 * F6 * F8 * F9 * Section_1 * Section_11 * Section_12 * Section_15 * Section_21 * Section_23 * Section_3 * Section_8).
