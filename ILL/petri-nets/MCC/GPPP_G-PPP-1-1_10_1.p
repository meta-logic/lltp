...
fof(con1, conjecture, ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * ADP * F6P * G6P * G6P * GSSG * NADPH * NADPplus * NADplus * NADplus * Pi * Pi * Pi * Pi * Pi * Pi * Pi * R5P * a2 * a2 * b1 * b2 * b2 * c1 * c1 * c1 * c1 * c1 * c1 * c1).
