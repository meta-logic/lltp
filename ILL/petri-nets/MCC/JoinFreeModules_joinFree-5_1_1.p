...
fof(con1, conjecture, p * p1 * p1 * p11 * p11 * p12 * p12 * p13 * p13 * p13 * p13 * p16 * p16 * p17 * p18 * p18 * p18 * p18 * p18 * p2 * p21 * p21 * p22 * p23 * p23 * p23 * p23 * p23 * p3 * p3 * p3 * p3 * p3 * p6 * p6 * p7 * p8 * p8 * p8 * p8 * p8).
