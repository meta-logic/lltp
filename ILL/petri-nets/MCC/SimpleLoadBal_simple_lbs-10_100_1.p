...
fof(con1, conjecture, P-client_idle_1 * P-client_waiting_10 * P-client_waiting_2 * P-client_waiting_3 * P-client_waiting_4 * P-client_waiting_5 * P-client_waiting_6 * P-client_waiting_7 * P-client_waiting_8 * P-client_waiting_9 * P-lb_idle_1 * P-lb_load_1_5 * P-lb_load_2_6 * P-server_processed_1 * P-server_processed_2 * P-server_request_10_2 * P-server_request_2_1 * P-server_request_3_2 * P-server_request_4_1 * P-server_request_5_2 * P-server_request_6_1 * P-server_request_7_2 * P-server_request_8_1 * P-server_request_9_2).
