...
fof(con1, conjecture, AMC_9_10 * Cpt1_1 * Cpt2_10 * FMCb * MSG_10 * RMC_10 * RMC_2 * RMC_3 * RMC_4 * RMC_5 * RMC_6 * RMC_7 * RMC_8 * R_tout * cable_used_1 * msgl_1 * msgl_10 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * msgl_7 * msgl_8 * msgl_9 * wait_ack_1_10 * wait_cable_10 * wait_cable_2 * wait_cable_3 * wait_cable_4 * wait_cable_5 * wait_cable_6 * wait_cable_7 * wait_cable_8 * wait_cable_9).
