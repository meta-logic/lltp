...
fof(con1, conjecture, flag_0_0 * flag_0_1 * flag_0_2 * flag_0_3 * flag_0_4 * flag_0_5 * flag_0_6 * flag_0_8 * flag_1_7 * flag_1_9 * p0_0 * p0_1 * p0_2 * p0_3 * p0_4 * p0_5 * p0_6 * p0_8 * p1_7 * p1_9).
