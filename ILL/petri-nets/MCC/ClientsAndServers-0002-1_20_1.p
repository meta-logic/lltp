...
%--------------------------------------------------------------------------
fof(inital_state, axiom, Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Mi * Mi * Mi * Si * Si * Si * Si * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci * Ci).
...
fof(con1, conjecture, CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CR * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * CwG * Mi * Mi * MpG * Si * Si * Si * SwG * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf * Uf).
