...
fof(con1, conjecture, DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * DeliveryHandlerDelivery_p8_0 * MerchantDelivery_p4_6 * OfferResponce_p10 * Organization_p21_2 * Organization_p21_2 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentHandlerPayment_p5_0 * PaymentRequest_p11_9 * Payment_p21_1 * Payment_p21_1 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p12_0 * p12_3 * p12_4 * p12_7 * p3_5 * p3_5 * p3_8 * p4_5 * p4_5).
