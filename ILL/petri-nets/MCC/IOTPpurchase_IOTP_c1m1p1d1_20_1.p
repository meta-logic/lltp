...
%--------------------------------------------------------------------------
fof(inital_state, axiom, ConsumerOffer_p1 * DeliveryHandlerDelivery_p8_0 * MerchantOffer_p2 * OfferResponce_p10 * PaymentHandlerPayment_p5_0 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7).
...
fof(con1, conjecture, DeliveryHandlerDelivery_p8_0 * MerchantDelivery_p4_6 * OfferResponce_p10 * Organization_p21_4 * PaySchemeData_p21_6 * PaymentHandlerPayment_p5_0 * Payment_p21_3 * Status_p21_5 * p10_0 * p11_0 * p11_11 * p11_13 * p11_3 * p11_4 * p11_7 * p11_8 * p12_0 * p12_3 * p12_4 * p12_7 * p3_7).
