...
fof(con1, conjecture, FB_deliver_run * arm1_magnet_off * arm1_retract_ext * arm1_stop * arm1_store_free * arm2_magnet_off * arm2_release_angle * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_start * belt2_light_barrier_false * belt2_stop * c_p1 * ch_A1P_free * ch_A2D_free * ch_DC_free * deposit_belt_idle * p_p1 * press_at_middle_pos * press_ready_for_loading * press_stop * robot_stop * swivel * table_bottom_pos * table_load_angle * table_ready_for_loading * table_stop_h * table_stop_v).
