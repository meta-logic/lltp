...
fof(con1, conjecture, AMC_1_2 * AMC_3_1 * AMC_4_3 * AMC_5_5 * AMC_6_4 * Cpt1_6 * Cpt2_1 * FMCb * R_tout * cable_free * listen_2 * msgl_1 * msgl_2 * msgl_3 * msgl_4 * msgl_5 * msgl_6 * wait_cable_1 * wait_cable_3 * wait_cable_4 * wait_cable_5 * wait_cable_6).
