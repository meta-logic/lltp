...
fof(con1, conjecture, AstopAbort * Cstart_0 * Cstart_1 * Cstart_10 * Cstart_2 * Cstart_3 * Cstart_4 * Cstart_5 * Cstart_6 * Cstart_7 * Cstart_8 * Cstart_9 * Sstart_0 * Sstart_10 * Sstart_2 * Sstart_4 * Sstart_6 * Sstart_7 * Sstart_8 * Sstart_9 * SstopAbort * SstopAbort * malicious_reservoir * malicious_reservoir * malicious_reservoir * malicious_reservoir * n1_0 * n1_10 * n1_2 * n1_3 * n1_4 * n1_5 * n1_6 * n1_7 * n1_8 * n1_9 * n2_1 * s2_1).
