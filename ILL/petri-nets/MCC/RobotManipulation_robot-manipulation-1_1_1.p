...
%--------------------------------------------------------------------------
fof(inital_state, axiom, r_stopped * r_stopped * access * access * p_i1 * p_i1 * p_i1).
...
fof(con1, conjecture, access * access * initialize * p_i1 * p_i1 * p_i2 * r_stopped * r_stopped).
