...
fof(con1, conjecture, F10 * F11 * F13 * F14 * F16 * F17 * F19 * F2 * F20 * F22 * F23 * F23 * F4 * F5 * F7 * F8 * Section_1 * Section_12 * Section_15 * Section_18 * Section_21 * Section_3 * Section_6 * Section_9).
