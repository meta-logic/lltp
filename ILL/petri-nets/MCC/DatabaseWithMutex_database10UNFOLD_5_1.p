...
fof(con1, conjecture, Active_1_1 * Message_2_1 * Message_3_1 * Message_4_1 * Message_5_1 * Message_6_1 * Message_7_1 * Message_8_1 * Message_9_1 * Mutex_10 * Mutex_2 * Mutex_3 * Mutex_4 * Mutex_5 * Mutex_6 * Mutex_7 * Mutex_8 * Mutex_9 * all_active_10 * all_active_2 * all_active_3 * all_active_4 * all_active_5 * all_active_6 * all_active_7 * all_active_8 * all_active_9 * all_passive_1 * all_passive_2 * all_passive_3 * all_passive_4 * all_passive_5 * all_passive_6 * all_passive_7 * all_passive_8 * all_passive_9 * updating_10_1).
