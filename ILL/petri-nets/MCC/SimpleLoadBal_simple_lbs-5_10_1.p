...
fof(con1, conjecture, P-client_idle_5 * P-client_request_1 * P-client_request_2 * P-client_request_4 * P-client_waiting_1 * P-client_waiting_2 * P-client_waiting_3 * P-client_waiting_4 * P-lb_load_1_1 * P-lb_load_2_0 * P-lb_routing_1_3 * P-server_idle_2 * P-server_processed_1).
