...
fof(con1, conjecture, F13 * F14 * F16 * F17 * F17 * F18 * F19 * F20 * F20 * F21 * F22 * F23 * F23 * F24 * F5 * F8 * Section_11 * Section_12 * Section_15 * Section_2 * Section_3 * Section_5 * Section_7 * Section_9).
