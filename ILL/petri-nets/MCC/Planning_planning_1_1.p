...
fof(con1, conjecture, p10 * p108 * p111 * p112 * p113 * p114 * p115 * p116 * p117 * p118 * p119 * p120 * p121 * p122 * p123 * p124 * p125 * p126 * p13 * p15 * p16 * p17 * p18 * p19 * p20 * p21 * p22 * p23 * p24 * p25 * p26 * p33 * p34 * p36 * p37 * p38 * p39 * p40 * p41 * p42 * p52 * p53 * p54 * p55 * p56 * p57 * p58 * p59 * p62 * p64 * p65 * p66 * p67 * p68 * p69 * p71 * p82 * p83 * p84 * p85 * p86 * p87 * p88 * p89 * p92).
