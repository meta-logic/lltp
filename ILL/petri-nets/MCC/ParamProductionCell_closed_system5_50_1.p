...
fof(con1, conjecture, A1L_ext_rs * DB_deliver_run * PU_lower_run * arm1_forward * arm1_magnet_off * arm1_pick_up_angle * arm1_pick_up_ext * arm2_magnet_off * arm2_retract_ext * arm2_stop * arm2_store_free * belt1_light_barrier_false * belt1_stop * belt2_light_barrier_false * belt2_start * crane_above_feed_belt * crane_mag_on * crane_stop_h * crane_stop_v * crane_storing * crane_transport_height * feed_belt_occupied * press_at_upper_pos * press_down * robot_stop * table_ready_for_unloading * table_stop_h * table_stop_v * table_top_pos * table_unload_angle).
