...
fof(con1, conjecture, AvailableJobId_1 * AvailableJobId_2 * AvailableJobId_3 * AwakeTasks_5 * AwakeTasks_6 * BlockedTasks * CreatedJobs_0_1 * CreatedJobs_4_2 * IdleTasks_2 * IdleTasks_3 * IdleTasks_4 * Idle_2 * Idle_3 * Idle_4 * Idle_5 * Idle_6 * IsMonitoring * JobCnt * JobCnt * MarkerRead * NoSigAbort * P_1095 * P_1113_1 * P_1158_1 * P_1724_4 * P_1725_0 * P_1726 * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cIdleTasks * cIdleTasks * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cPollingAbort).
