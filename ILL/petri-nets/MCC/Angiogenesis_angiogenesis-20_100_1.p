...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Akt * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarP3kStar * KdStarGStarPg * KdStarGStarPg * KdStarGStarPgStar * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * KdStarPg * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * P3k * Pg * Pg * Pg * Pg * Pg * Pg * Pg * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2 * PtP2).
