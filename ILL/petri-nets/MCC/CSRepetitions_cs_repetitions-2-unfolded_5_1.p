...
fof(con1, conjecture, Client_Sending_1 * Client_Sending_3 * Client_Sending_4 * Client_Waiting_2 * RequestBuffer_3 * RequestBuffer_3 * Server_Waiting_1 * Server_Waiting_2).
