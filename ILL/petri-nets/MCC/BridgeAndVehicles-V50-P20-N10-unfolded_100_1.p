...
fof(con1, conjecture, ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_A * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * ATTENTE_B * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * CAPACITE * COMPTEUR_0 * NB_ATTENTE_A_19 * NB_ATTENTE_B_50 * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * ROUTE_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * SUR_PONT_A * VIDANGE_2).
