...
fof(con1, conjecture, AvailableJobId_1 * AvailableJobId_2 * AvailableJobId_3 * BlockedTasks * CreatedJobs_0_1 * CreatedJobs_4_2 * IdleTasks_2 * IdleTasks_3 * IdleTasks_4 * IdleTasks_5 * IdleTasks_6 * Idle_2 * Idle_3 * Idle_4 * Idle_5 * Idle_6 * IsMonitoring * JobCnt * JobCnt * MarkerRead * NoSigAbort * P_1095 * P_1095 * P_1725_0 * P_1727 * QueueJobB_1_4 * QueueJobE_1 * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cBlockedTasks * cIdleTasks * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cJobCnt * cPollingAbort).
