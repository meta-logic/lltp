...
%--------------------------------------------------------------------------
fof(inital_state, axiom, P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P4 * P4 * P4 * P4 * P4 * P4 * P4 * P4 * P4 * P4 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2).
...
fof(con1, conjecture, P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P1 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P2 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * P3 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4 * Pout4).
