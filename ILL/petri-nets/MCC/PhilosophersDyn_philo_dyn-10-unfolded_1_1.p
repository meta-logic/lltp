...
fof(con1, conjecture, Forks_1 * Forks_3 * Neighbourhood_1_3 * Neighbourhood_3_1 * Outside_10 * Outside_2 * Outside_4 * Outside_5 * Outside_6 * Outside_7 * Outside_8 * Outside_9 * Think_1 * Think_3).
