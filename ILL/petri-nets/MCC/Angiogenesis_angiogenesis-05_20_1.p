...
fof(con1, conjecture, Akt * Akt * Akt * Akt * Akt * DAG * DAGE * DAGE * Enz * Enz * Enz * Gab1 * Gab1 * Gab1 * Gab1 * Gab1 * KdStarPg * KdStarPgStar * KdStarPgStar * KdStarPgStar * KdStarPgStar * P3k * P3k * P3k * P3k * P3k * Pip2 * Pip2 * Pten * Pten * Pten * Pten * Pten).
